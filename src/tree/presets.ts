...
export const PRESETS: TreePreset[] = [
  {
    id: "map_type",
    name: "ข้อมูลผูกกับสถานที่: เลือกแผนที่แบบไหน? (locked)",
    locked: true,
    style: "neutral",
  ...
  {
    id: "include_zero",
    name: "แกนตัวเลขต้องรวม 0 ไหม? (locked)",
    locked: true,
    style: "neutral",
  ...
  },
  {
    ...
    name: "เลือกขอบล่างของสเกลตัวเลข (locked)",
    locked: true,
    style: "neutral",
  ...
  {
    id: "over_time",
    name: "ข้อมูลเปลี่ยนตามเวลา: ใช้กราฟแบบไหน? (locked)",
    locked: true,
    style: "neutral",
  ...
  {
    id: "total_over_time",
    name: "ตามเวลา + มีหลายส่วน: เน้นยอดรวมหรือสัดส่วน? (locked)",
    locked: true,
    style: "neutral",
  ...
  {
    id: "several_totals",
    name: "หลายยอดรวม: เทียบส่วนประกอบข้ามกลุ่ม (locked)",
    locked: true,
    style: "neutral",
  ...
  {
    id: "single_total",
    name: "ยอดรวมก้อนเดียว: แสดงส่วนประกอบยังไง? (locked)",
    locked: true,
    style: "neutral",
  ...
  {
    id: "bar_chart",
    name: "เมื่อไหร่ควรใช้กราฟแท่ง? (locked)",
    locked: true,
    style: "neutral",
